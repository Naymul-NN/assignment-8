...
const Banner = () => {
  ...
  const toggleClear = () => {
    ...
    return (
        <div>
            <div className="relative  h-[50vh]  w-full bg-no-repeat	bg-cover bg-[url('https://i.ibb.co/48w1dfd/b4.jpg')]">
             <div className="absolute inset-0 bg-white  bg-opacity-50"></div>
            </div>
           <div className="relative mt-[-150px]">  
           <h1 className="lg:pl-36 lg:text-3xl font-bold text-black">Humenity is love So spread the love</h1> 
            <input className="border border-sky-200 lg:ml-60 mt-3 py-2 lg:pr-24 rounded-l-lg" 
            type="text"
            ...
            <div className=" grid pl-10 md:pl-10 lg:pl-0 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5  pt-12">
                {
